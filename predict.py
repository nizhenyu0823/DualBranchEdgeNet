...
def get_args():
    ...
    # parser.add_argument("--train-dataset", type=str, default="CVC", choices=["Kvasir", "CVC"])
    # parser.add_argument("--test-dataset", type=str, default="CVC", choices=["Kvasir", "CVC"])
    # parser.add_argument("--data-root", type=str, default="./dataset/CVC-ClinicDB/", dest="root")

    parser.add_argument("--train-dataset", type=str, default="CVC")
    parser.add_argument("--test-dataset", type=str, default="CVC")
    parser.add_argument("--data-root", type=str, default="./dataset/CVC-ClinicDB/", dest="root")
